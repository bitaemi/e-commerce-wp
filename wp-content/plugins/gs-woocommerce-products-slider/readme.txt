...
Either you are selling digital or tangible products from the WooCommerce powered store, presentation matters in your each turn. Until you make presentation engaging and fastidious, you can’t interact with targeted audience and convey them perfect message your want. Woocommerce Product slider can really help you to grow your online business.

With Woocommerce Product slider plugin, you can quickly add you a “Digital Signage” for any purposes like introducing new products, brand awareness, increase exposure, driving sales, and so on. To enable such feature in your WooCommerce website, you don’t need knowledge of coding and artistic sense of slider designing. GS WooCommerce Product Slider is a great WordPress plugin to fullfil your need to showcase products in a nice sliding manner. It's the best Responsive WooCommerce Product Slider plugin for your WordPress site. Display anywhere at your site using shortcode like [gs_wps theme="gs-effect-1"]

GS WooCommerce Product Slider plugin is simple, flexible & powerful.

### GS WooCommerce Product Slider by https://www.gsamdani.com

>[ Live Demo](http://www.wooprod.gsamdani.com) | [Upgrade to PRO](https://www.gsamdani.com/product/gs-woocommerce-product-slider) | [Documentation](http://www.wooprod.gsamdani.com/documentation) | [Support](https://www.gsamdani.com/support) | [Contact](https://www.gsamdani.com/contact)  
...
* 2 Different amazing Query / shortcode builder with all necessary options.
	* From Menu : GS Plugins > Generate Shortcode, you can set your query then copy shortcode to paste anywhere
...
* Visual Composer custom element. ( You can select Generated query )
...
* On / off contols for – Autoplay, Stop on Hover, Inifnity Loop, Navigation, Dots navigation, Dot for Each
...
`
<?php echo do_shortcode( '[gs_wps theme="gs-effect-1"]' ); ?>
`

### Confused?

*   [View live Demos &raquo;](http://www.wooprod.gsamdani.com)
*   [Documentation &raquo;](http://www.wooprod.gsamdani.com/documentation)
...
* Before install GS WooCommerce Product Slider make sure you've already installed WooCommerce plugin. 

*   [Visual Installation & Usage Guide &raquo;](http://www.wooprod.gsamdani.com/documentation)
...
* Put [gs_wps theme="gs-effect-1"] shortcode or select other theme, where you need to show the Woocommerce Product slider.
...
WordPress has a great function, do_shortcode(), that will allow you to use shortcodes inside your theme files. For example, to output Woocommerce Product slider in a Theme file, you would do this: 
`
<?php echo do_shortcode('[gs_wps theme="gs-effect-1"]'); ?>
`
...
8. WooCommerce Product Slider Query Builder / Generate Shortcode (Pro)
