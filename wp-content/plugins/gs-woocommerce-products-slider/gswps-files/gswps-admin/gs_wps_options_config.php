...
class GS_wps_Settings_Config {
        ...
        $settings_fields = array(
            'gs_wps_general' => array(
                ...
                array(
                    ...
                    'desc'  => __( 'Select Total number of products in slider. Default 10', 'gswps' ),
                    'type'  => 'number',
                    'min'   => 1,
                    'max'   => 100,
                    'default' => 10
                ...
                array(
                    ...
                    'label'     => __( 'Inifnity Loop', 'gswps' ),
                    'desc'      => __( 'Enable / Disable Inifnity loop. Duplicates last & first Product to get loop illusion. Default On', 'gswps' ),
                    'type'      => 'switch',
                    'switch_default' => 'ON'
                ),
                 // Margin
    ...
    function plugin_page() {
        settings_errors();
        echo '<div class="wrap gs_wps_wrap" style="width: 845px; float: left;">';
