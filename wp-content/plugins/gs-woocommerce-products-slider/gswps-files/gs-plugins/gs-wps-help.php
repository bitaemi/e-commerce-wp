...
add_action('admin_menu', 'gs_wps_help_menu', 11);

function gswps_help_menu_cb() {
	?>

    <div class="wrap">
        
        <div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 50px; text-align: center;">
            <h1>GS WooCommerce Product Slider by GS Plugins</h1>
            <div class="help-link">
                <a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsamdani.com/product/gs-woocommerce-product-slider" target="_blank">Plugin Home</a>
            <a class="gstm-hlp-btn gstm-btn-2" href="http://www.wooprod.gsamdani.com" target="_blank">Live Demo</a>
            <a class="gstm-hlp-btn gstm-btn-3" href="http://www.wooprod.gsamdani.com/documentation" target="_blank">Documentation</a>
            <a class="gstm-hlp-btn gstm-btn-4" href="http://www.wooprod.gsamdani.com/documentation/#GS_WooCommerce_Product_Slider8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
