...
function foster_charity_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'foster_charity_panel_id', array(
	    ...
	    'theme_supports' => '',
	    'title' => __( 'Theme Settings', 'emi-development' ),
	    'description' => __( 'Description of what this panel does.', 'emi-development' ),
	) );

	$wp_customize->add_section( 'foster_charity_general_option', array(
    	'title'      => __( 'Sidebar Settings', 'emi-development' ),
		'priority'   => 30,
	...
	$wp_customize->add_setting('foster_charity_layout_settings',array(
        'default' => __('Right Sidebar','emi-development'),
        'sanitize_callback' => 'foster_charity_sanitize_choices'	        
	));

	$wp_customize->add_control('foster_charity_layout_settings',array(
        'type' => 'radio',
        'label'     => __('Theme Sidebar Layouts', 'emi-development'),
        'description'   => __('This option work for blog page, blog single page, archive page and search page.', 'emi-development'),
        'section' => 'foster_charity_general_option',
        'choices' => array(
            'Left Sidebar' => __('Left Sidebar','emi-development'),
            'Right Sidebar' => __('Right Sidebar','emi-development'),
            'One Column' => __('Full Width','emi-development'),
            'Grid Layout' => __('Grid Layout','emi-development')
        ),
	));

	//Topbar section
	$wp_customize->add_section('foster_charity_topbar',array(
		'title'	=> __('Topbar','emi-development'),
		'description'	=> __('Add Topbar Content here','emi-development'),
		'priority'	=> null,
		'panel' => 'foster_charity_panel_id',
	));
	...
	$wp_customize->add_control('foster_charity_email',array(
		'label'	=> __('Add Email','emi-development'),
	...
	$wp_customize->add_control('foster_charity_call1',array(
		'label'	=> __('Add Phone Number','emi-development'),
		'section'	=> 'foster_charity_topbar',
	...
	$wp_customize->add_control('foster_charity_donate',array(
		'label'	=> __('Donate button text','emi-development'),
		'section'	=> 'foster_charity_topbar',
		'type'		=> 'text'
	));
	...
	$wp_customize->add_control('foster_charity_donate_link',array(
		'label'	=> __('Add Donate Link','emi-development'),
		'section'	=> 'foster_charity_topbar',
	...
	$wp_customize->add_section('foster_charity_social_link',array(
		'title'	=> __('Social Media','emi-development'),
		'description'	=> __('Add Social Media Url here','emi-development'),
		'priority'	=> null,
		'panel' => 'foster_charity_panel_id',
	));
	...
	$wp_customize->add_control('foster_charity_facebook_url',array(
		'label'	=> __('Add Facebook link','emi-development'),
	...
	$wp_customize->add_control('foster_charity_twitter_url',array(
		'label'	=> __('Add Twitter link','emi-development'),
		'section'	=> 'foster_charity_social_link',
	...
	$wp_customize->add_control('foster_charity_google_plus_url',array(
		'label'	=> __('Add Google Plus link','emi-development'),
		'section'	=> 'foster_charity_social_link',
	...
	$wp_customize->add_control('foster_charity_instagram_url',array(
		'label'	=> __('Add instagram link','emi-development'),
		'section'	=> 'foster_charity_social_link',
	...
	$wp_customize->add_control('foster_charity_youtube_url',array(
		'label'	=> __('Add Youtube link','emi-development'),
		'section'	=> 'foster_charity_social_link',
	...
	$wp_customize->add_control('foster_charity_linkdin_url',array(
		'label'	=> __('Add Linkdin link','emi-development'),
		'section'	=> 'foster_charity_social_link',
	...
	$wp_customize->add_section( 'foster_charity_slider' , array(
    	'title'      => __( 'Slider Settings', 'emi-development' ),
		'priority'   => null,
		'panel' => 'foster_charity_panel_id'
	) );
	...
	$wp_customize->add_control('foster_charity_slider_arrows',array(
     	'type' => 'checkbox',
      	'label' => __('Show / Hide slider','emi-development'),
	...
	for ( $count = 1; $count <= 4; $count++ ) {
		...
		$wp_customize->add_control( 'foster_charity_slide_page' . $count, array(
			'label'    => __( 'Select Slide Image Page', 'emi-development' ),
			'section'  => 'foster_charity_slider',
			'type'     => 'dropdown-pages'
		) );
	...
	$wp_customize->add_section('foster_charity_how_can_you_help',array(
		'title'	=> __('How Can You Help','emi-development'),
		'description'	=> __('Add Service Section below.','emi-development'),
		'panel' => 'foster_charity_panel_id',
	));
	...
	$wp_customize->add_control('foster_charity_section_title',array(
		'label'	=> __('Section title','emi-development'),
	...
	$wp_customize->add_control('foster_charity_single_post',array(
		'type'    => 'select',
		'choices' => $pst,
		'label' => __('Select post','emi-development'),
		'section' => 'foster_charity_how_can_you_help',
	));
	...
	$wp_customize->add_section( 'foster_charity_footer' , array(
    	'title'      => __( 'Footer Text', 'emi-development' ),
		'priority'   => null,
		'panel' => 'foster_charity_panel_id'
	) );
	...
	$wp_customize->add_control('foster_charity_footer_text',array(
		'label'	=> __('Add Copyright Text','emi-development'),
 ...
 * @see emi-development_customize_register()
 *
 * @return void
 */
...
final class Foster_Charity_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Foster_Charity_Customize_Section_Pro(
				...
				array(
					'priority'   => 9,
					'title'    => esc_html__( 'Foster Charity Pro', 'emi-development' ),
					'pro_text' => esc_html__( 'Go Pro', 'emi-development' ),
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'emi-development-customize-controls', trailingslashit( get_template_directory_uri() ) . '/assets/js/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'emi-development-customize-controls', trailingslashit( get_template_directory_uri() ) . '/assets/css/customize-controls.css' );
	}
}
