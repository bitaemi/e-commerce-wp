            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <div class ="readbutton">
                  <a href="<?php the_permalink(); ?>"> <?php echo esc_html(get_theme_mod('foster_charity_slide_page',__('READ MORE','emi-development'))); ?></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-4">            
        <?php
          $postData = get_theme_mod('foster_charity_single_post');
            if($postData){
            $args = array( 'name' => esc_html( $postData ,'emi-development'));
          $query = new WP_Query( $args );
          if ( $query->have_posts() ) :
